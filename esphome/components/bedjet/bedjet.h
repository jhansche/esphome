...
static const espbt::ESPBTUUID BEDJET_SERVICE_UUID =
    espbt::ESPBTUUID::from_raw((uint8_t []) {
      0x74, 0x65, 0x4a, 0x64, 0x65, 0x42,
      0x55, 0xaa, 0x80, 0x00, 0xd0, 0xbe,
      0x00, 0x10, 0x00, 0x00
    });

// "00002000-bed0-0080-aa55-4265644a6574"
static const espbt::ESPBTUUID BEDJET_STATUS_UUID =
    espbt::ESPBTUUID::from_raw((uint8_t []) {
      0x74, 0x65, 0x4a, 0x64, 0x65, 0x42,
      0x55, 0xaa, 0x80, 0x00, 0xd0, 0xbe,
      0x00, 0x20, 0x00, 0x00
...
static const espbt::ESPBTUUID BEDJET_COMMAND_UUID =
    espbt::ESPBTUUID::from_raw((uint8_t []) {
      0x74, 0x65, 0x4a, 0x64, 0x65, 0x42,
      0x55, 0xaa, 0x80, 0x00, 0xd0, 0xbe,
      0x04, 0x20, 0x00, 0x00
...
static const espbt::ESPBTUUID BEDJET_NAME_UUID =
    espbt::ESPBTUUID::from_raw((uint8_t []) {
      0x74, 0x65, 0x4a, 0x64, 0x65, 0x42,
      0x55, 0xaa, 0x80, 0x00, 0xd0, 0xbe,
      0x01, 0x20, 0x00, 0x00
